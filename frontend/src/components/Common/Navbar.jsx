      ...
      <div className="container-fluid nav-inner">
        ...
        >
          <ul className="navbar-nav mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link className="nav-link fw-bold text-light" to="/shop">
                Shop
              </Link>
            </li>
            <li className="nav-item">
            ...
            <li className="nav-item">
              <Link className="nav-link fw-bold text-light" to="/blog">
                Blog
              </Link>
            </li>
          </ul>
        ...
        <div className="nav-right-group">
          <Link to="/becomedealer">
            <button className="btn dealer">Become a Dealer</button>
          </Link>

          <div onClick={handleCartClick} style={{ cursor: "pointer" }}>
            <Badge count={cartCount} offset={[0, 0]} size="small" color="black">
